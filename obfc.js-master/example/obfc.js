...
function Ve(_middle_x, _middle_y, _size, _text, _text_size, _description, _fill_color, _stroke_color, _text_color) {
    Process.call(this, _middle_x, _middle_y, _size, _text, _text_size, _description, _fill_color, _stroke_color, _text_color);
    this.Name = "Ve";
    ...
    this.Draw = function () {
        temp = "<g id=\"" + this.ID + "\" onclick=\"doClick_Object(evt)\" style=\"cursor:pointer\">";
        temp += "<path d=\"M " + (this.start_x + 15 * this.size) + " " + this.start_y + " L " + ((this.start_x + this.width - 60 * this.size)) + " " + (this.start_y) + " ";
        temp += "Q " + (this.start_x + this.width -25 * this.size) + " " + (this.middle_y) + ", " + ((this.start_x + this.width - 60 * this.size)) + " " + (this.start_y + this.height);
        temp += "L " + (this.start_x + 15 * this.size) + " " + (this.start_y + this.height) + " ";
        temp += "H " + (this.start_x+15) + " Z\"";
        temp += " style=\"fill:" + this.fill_color + ";stroke:" + this.stroke_color + ";stroke-width:2\" />";
        if (this.text.length > 0)
            temp += writeText(this.text, this.text_size, "normal", this.middle_x-20, this.middle_y, this.height, "center", _text_color);
        temp += "</g>";
...
function Veya(_middle_x, _middle_y, _size, _text, _text_size, _description, _fill_color, _stroke_color, _text_color) {
    Process.call(this, _middle_x, _middle_y, _size, _text, _text_size, _description, _fill_color, _stroke_color, _text_color);
    this.Name = "Veya";
    ...
    this.Draw = function () {
        temp = "<g id=\"" + this.ID + "\" onclick=\"doClick_Object(evt)\" style=\"cursor:pointer\">";
        temp += "<path d=\"M " + (this.start_x + 15 * this.size) + " " + this.start_y +  " ";
		//L " + ((this.start_x + this.width - 60 * this.size)) + " " + (this.start_y) +
        temp += "q " + (this.height)/2 + " " + ((this.height)/2) + ", 0 " + (this.height);
        //temp += "L " + (this.start_x + 15 * this.size) + " " + (this.start_y + this.height) + " ";
        temp += "a " + (this.height) + ","+(this.height/10*7)+" 0,0,0, "+(this.height*1.2)+","+((this.height*-1)/2)+" ";
        temp += "a " + (this.height) + ","+(this.height/10*7)+" 0,0,0, "+((this.height*1.2)*-1)+","+((this.height*-1)/2)+" z";
		temp += "\"";
        temp += " style=\"fill:" + this.fill_color + ";stroke:" + this.stroke_color + ";stroke-width:2\" />";
        if (this.text.length > 0)
            temp += writeText(this.text, this.text_size, "normal", this.middle_x-15, this.middle_y, this.height, "center", _text_color);
        temp += "</g>";
/*
